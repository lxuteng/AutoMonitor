...
where
period_start_time >= to_date(to_char(sysdate-1/24,'yyyymmddhh24'),'YYYYMMDDHH24') 
and period_start_time < to_date(to_char(sysdate,'YYYYMMDDHH24'),'YYYYMMDDHH24')
...
AND CEL.CONF_ID=1 
AND CEL.OBJ_GID =M8013.LNCEL_ID
