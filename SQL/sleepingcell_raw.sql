...
, TO_CHAR(sysdate,'yyyymmddhh24MI')   sdatetime
--,M8013.sdatetime
...
From
NOKLTE_PS_LRDB_MNC1_RAW p  --PM8007
...
--,LNCEL_ID
,to_char(period_start_time,'yyyymmddhh24MI')||LNCEL_ID
...
From
NOKLTE_PS_LUEST_MNC1_RAW p   --PM8013
,utp_common_objects lnbts
,utp_common_objects lncel
...
And ((M8007C8=0 and M8007C7>5) or( M8013C5=0 and (M8013C24)+(M8013C25)>250) or (M8007C8=0 and (M8013C24)+(M8013C25)>250))

Having
count(m8013.enb)>7      --休眠时段数
