...
-- ,round(sum(M8006C45)/3600,2) QCI1话务量Erl
...
,case when length(&1)=8 and length(&2)=8 then round(decode(avg(M8001C217)+ avg(M8001C216),0,0,(avg(M8011C50)/(24*60*60*1000/5)+ avg(M8011C37)/(10*4/5))/(avg(M8001C217)+ avg(M8001C216)))*100,2) 
      when length(&1)=10 and length(&2)=10 then round(decode(avg(M8001C217)+ avg(M8001C216),0,0,(avg(M8011C50)/(60*60*1000/5)+ avg(M8011C37)/(10*4/5))/(avg(M8001C217)+ avg(M8001C216)))*100,2)
      when length(&1)=12 and length(&2)=12 then round(decode(avg(M8001C217)+ avg(M8001C216),0,0,(avg(M8011C50)/(15*60*1000/5)+ avg(M8011C37)/(10*4/5))/(avg(M8001C217)+ avg(M8001C216)))*100,2)
end 无线利用率
,case when length(&1)=8 and length(&2)=8 then round(avg(M8011C50)/(24*60*60*1000/5)+ avg(M8011C37)/(10*4/5),0)
      when length(&1)=10 and length(&2)=10 then round(avg(M8011C50)/(60*60*1000/5)+ avg(M8011C37)/(10*4/5),0)
      when length(&1)=12 and length(&2)=12 then round(avg(M8011C50)/(15*60*1000/5)+ avg(M8011C37)/(10*4/5),0)
end 无线利用率分子
...
,M8009C15,M8009C16,M8014C23,M8014C24,M8014C26,M8014C27,M8006C287,M8006C291
...
,case when round((M8006C181)/3600,2) > 1 
			and M8006C181 is not null 
	then 1 
	else 0 end 总小区数
,case when round((M8006C181)/3600,2) > 1 
			and M8006C181 is not null 
...
WHERE      M8012.cel_key_id=m8001.cel_key_id(+)
       AND M8012.cel_key_id=m8005.cel_key_id(+)
       AND M8012.cel_key_id=m8006.cel_key_id(+)
       AND M8012.cel_key_id=m8008.cel_key_id(+)
       AND M8012.cel_key_id=m8009.cel_key_id(+)
       AND M8012.cel_key_id=m8010.cel_key_id(+)
       AND M8012.cel_key_id=m8011.cel_key_id(+)
       AND M8012.cel_key_id=m8013.cel_key_id(+)
       AND M8012.cel_key_id=m8014.cel_key_id(+)
       AND M8012.cel_key_id=m8015.cel_key_id(+)
       AND M8012.cel_key_id=m8016.cel_key_id(+)
       AND M8012.cel_key_id=m8020.cel_key_id(+)
       AND M8012.cel_key_id=m8007.cel_key_id(+)
       AND M8012.cel_key_id=m8026.cel_key_id(+)
