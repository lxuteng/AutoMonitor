...
,round(decode(avg(M8001C217)+ avg(M8001C216),0,0,(avg(M8011C50)/(15*60*1000*1/5) + avg(M8011C37)/10*avg(M8001C216)/100)/(avg(M8001C217)+ avg(M8001C216)))*100,2) 无线利用率  --2017年10月13日更新
,round(avg(M8011C50)/(15*60*1000*1/5) + avg(M8011C37)/10*avg(M8001C216)/100) 无线利用率分子 --2017年10月13日更新
...
,round(sum("话务量_亿阳"),2) "QCI1话务量Erl_亿阳"
FROM
(
SELECT comm.sdate
          --   ,M8020.MRBTS_ID
...
,M8009C15,M8009C16,M8014C23,M8014C24,M8014C26,M8014C27,M8006C287,M8006C291,M8016C54,话务量_亿阳
