...
,case when "QCI1话务量Erl_亿阳" > 1 
			and "QCI1话务量Erl_亿阳" is not null 
			and Decode((M8006C206+M8006C215)+ decode((M8006C54),0,0,ceil((M8006C45)/(M8006C54))),0,0,round(100*(M8006C176+M8006C269+M8006C273)/((M8006C206+M8006C215)+ decode((M8006C54),0,0,ceil((M8006C45)/(M8006C54)))),2)) > 1
...
ORDER BY substr(sdate,1,8),&3 desc--,enb_cell,enb_id

)

where rownum <&5 and &3 > &4